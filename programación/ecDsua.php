...
<div id="wrapper"><!-- Aquí se envuelve todo el contenido de la página -->
	...
	<form align='justify' id="examen" action="rDsua.php" method="POST" style='width:600px;margin-left:400px;'>
	<font size="3">	
	...
	$Termino=consultaUnica("select Termino from bdSUA where Cuenta=$_SESSION[Cuenta]");		
	//$Etapa=consultaUnica("select Etapa from bdSUA where Cuenta=$_SESSION[Cuenta]");
	...
	{
		$Cal=consultaUnica("select Calificacion from bdSUA where Cuenta=$_SESSION[Cuenta]");
		echo "Ya haz hecho el examen<br/>El resultado de tu evaluación es: $Cal";
		echo "<br/><br/><u><a href='salirDsua.php' style='color:black'>Cerrar Sesión</a></u>";
	}		
?>
